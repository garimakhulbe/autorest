...
func (s *RequiredOptionalSuite) TestPostRequiredArrayHeader(c *chk.C) {
	...
	c.Assert(err.Error(), chk.Equals, validation.NewErrorWithValidationError(expected, "optionalgroup.ExplicitClient", "PostRequiredArrayHeader").Error())
}
...
func (s *RequiredOptionalSuite) TestPostRequiredArrayParameter(c *chk.C) {
	...
	c.Assert(err.Error(), chk.Equals, validation.NewErrorWithValidationError(expected, "optionalgroup.ExplicitClient", "PostRequiredArrayParameter").Error())
}
...
func (s *RequiredOptionalSuite) TestPostRequiredArrayProperty(c *chk.C) {
	...
	c.Assert(err.Error(), chk.Equals, validation.NewErrorWithValidationError(expected, "optionalgroup.ExplicitClient", "PostRequiredArrayProperty").Error())
}
...
func (s *RequiredOptionalSuite) TestPostRequiredClassParameter(c *chk.C) {
	...
	c.Assert(err.Error(), chk.Equals, validation.NewErrorWithValidationError(expected, "optionalgroup.ExplicitClient", "PostRequiredClassParameter").Error())
}
...
func (s *RequiredOptionalSuite) TestPostRequiredClassProperty(c *chk.C) {
	...
	c.Assert(err.Error(), chk.Equals, validation.NewErrorWithValidationError(expected, "optionalgroup.ExplicitClient", "PostRequiredClassProperty").Error())
}
...
func (s *RequiredOptionalSuite) TestPostRequiredIntegerProperty(c *chk.C) {
	...
	c.Assert(err.Error(), chk.Equals, validation.NewErrorWithValidationError(expected, "optionalgroup.ExplicitClient", "PostRequiredIntegerProperty").Error())
}
