...
func (client ManagementClient) PostFlattenedSimpleProduct(simpleBodyProduct *SimpleProduct) (result SimpleProduct, err error) {
    if err := validation.Validate([]validation.Validation{
         ...
         []validation.Constraint{	{"MaxProductDisplayName", validation.Null, true ,
         []validation.Constraint{	{"MaxProductDisplayName", validation.Empty, true, nil },
         }},
         	{"MaxProductCapacity", validation.Null, true ,
         []validation.Constraint{	{"MaxProductCapacity", validation.Empty, true, nil },
         }},
         }},
         }}}}}); err != nil {
...
func (client ManagementClient) PutSimpleProductWithGrouping(name string, simpleBodyProduct *SimpleProduct) (result SimpleProduct, err error) {
    if err := validation.Validate([]validation.Validation{
         ...
         {name,
         []validation.Constraint{	{"name", validation.Empty, true, nil }}}}); err != nil {
