...
func (client BasicOperationsClient) PutValid(complexBody Basic) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {client.APIVersion,
         []validation.Constraint{	{"client.APIVersion", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "complexgroup.BasicOperationsClient", "PutValid", nil , "Validation error ")
    }
