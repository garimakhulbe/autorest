...
func (client EnumClient) PutNotExpandable(stringBody Colors) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {stringBody,
         []validation.Constraint{	{"stringBody", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "stringgroup.EnumClient", "PutNotExpandable", nil , "Validation error ")
    }
...
func (client EnumClient) PutReferenced(enumStringBody Colors) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {enumStringBody,
         []validation.Constraint{	{"enumStringBody", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "stringgroup.EnumClient", "PutReferenced", nil , "Validation error ")
    }
...
func (client EnumClient) PutReferencedConstant(enumStringBody RefColorConstant) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {enumStringBody,
         []validation.Constraint{	{"ColorConstant", validation.Null, true ,
         []validation.Constraint{	{"ColorConstant", validation.Empty, true, nil },
         }}}}}); err != nil {
