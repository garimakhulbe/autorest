...
func (client OperationsClient) PutEmpty(stringBody string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         ...
         []validation.Constraint{	{"stringBody", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "stringgroup.OperationsClient", "PutEmpty", nil , "Validation error ")
    }
...
func (client OperationsClient) PutMbcs(stringBody string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {stringBody,
         []validation.Constraint{	{"stringBody", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "stringgroup.OperationsClient", "PutMbcs", nil , "Validation error ")
    }
...
func (client OperationsClient) PutWhitespace(stringBody string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {stringBody,
         []validation.Constraint{	{"stringBody", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "stringgroup.OperationsClient", "PutWhitespace", nil , "Validation error ")
    }
