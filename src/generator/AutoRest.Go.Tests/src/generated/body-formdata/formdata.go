...
func (client FormdataClient) UploadFile(fileContent io.ReadCloser, fileName string) (result ReadCloser, err error) {
    if err := validation.Validate([]validation.Validation{
         {fileName,
         []validation.Constraint{	{"fileName", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "formdatagroup.FormdataClient", "UploadFile", nil , "Validation error ")
    }
