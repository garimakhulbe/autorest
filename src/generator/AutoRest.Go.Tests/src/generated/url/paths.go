...
func (client PathsClient) ArrayCsvInPath(arrayPath []string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {arrayPath,
         []validation.Constraint{	{"arrayPath", validation.Null, true ,
         []validation.Constraint{	{"arrayPath", validation.Empty, true, nil },
         }}}}}); err != nil {
...
func (client PathsClient) ByteEmpty(bytePath []byte) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {bytePath,
         []validation.Constraint{	{"bytePath", validation.Null, true ,
         []validation.Constraint{	{"bytePath", validation.Empty, true, nil },
         }}}}}); err != nil {
...
func (client PathsClient) EnumNull(enumPath URIColor) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {enumPath,
         []validation.Constraint{	{"enumPath", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "urlgroup.PathsClient", "EnumNull", nil , "Validation error ")
    }
...
func (client PathsClient) EnumValid(enumPath URIColor) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {enumPath,
         []validation.Constraint{	{"enumPath", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "urlgroup.PathsClient", "EnumValid", nil , "Validation error ")
    }
...
func (client PathsClient) StringEmpty(stringPath string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {stringPath,
         []validation.Constraint{	{"stringPath", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "urlgroup.PathsClient", "StringEmpty", nil , "Validation error ")
    }
...
func (client PathsClient) StringNull(stringPath string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {stringPath,
         []validation.Constraint{	{"stringPath", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "urlgroup.PathsClient", "StringNull", nil , "Validation error ")
    }
...
func (client PathsClient) StringUnicode(stringPath string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {stringPath,
         []validation.Constraint{	{"stringPath", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "urlgroup.PathsClient", "StringUnicode", nil , "Validation error ")
    }
...
func (client PathsClient) StringURLEncoded(stringPath string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {stringPath,
         []validation.Constraint{	{"stringPath", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "urlgroup.PathsClient", "StringURLEncoded", nil , "Validation error ")
    }
