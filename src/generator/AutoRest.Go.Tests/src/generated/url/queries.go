...
func (client QueriesClient) ByteEmpty(byteQuery []byte) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {byteQuery,
         []validation.Constraint{	{"byteQuery", validation.Null, true ,
         []validation.Constraint{	{"byteQuery", validation.Empty, true, nil },
         }}}}}); err != nil {
...
func (client QueriesClient) StringEmpty(stringQuery string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {stringQuery,
         []validation.Constraint{	{"stringQuery", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "urlgroup.QueriesClient", "StringEmpty", nil , "Validation error ")
    }
...
func (client QueriesClient) StringUnicode(stringQuery string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {stringQuery,
         []validation.Constraint{	{"stringQuery", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "urlgroup.QueriesClient", "StringUnicode", nil , "Validation error ")
    }
...
func (client QueriesClient) StringURLEncoded(stringQuery string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {stringQuery,
         []validation.Constraint{	{"stringQuery", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "urlgroup.QueriesClient", "StringURLEncoded", nil , "Validation error ")
    }
