...
func (client ImplicitClient) GetRequiredGlobalPath() (result Error, err error) {
    if err := validation.Validate([]validation.Validation{
         ...
         []validation.Constraint{	{"client.RequiredGlobalPath", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "optionalgroup.ImplicitClient", "GetRequiredGlobalPath", nil , "Validation error ")
    }
...
func (client ImplicitClient) GetRequiredGlobalQuery() (result Error, err error) {
    if err := validation.Validate([]validation.Validation{
         ...
         []validation.Constraint{	{"client.RequiredGlobalQuery", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "optionalgroup.ImplicitClient", "GetRequiredGlobalQuery", nil , "Validation error ")
    }
...
func (client ImplicitClient) GetRequiredPath(pathParameter string) (result Error, err error) {
    if err := validation.Validate([]validation.Validation{
         {pathParameter,
         []validation.Constraint{	{"pathParameter", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "optionalgroup.ImplicitClient", "GetRequiredPath", nil , "Validation error ")
    }
