...
func (client ExplicitClient) PostRequiredArrayHeader(headerParameter []string) (result Error, err error) {
    if err := validation.Validate([]validation.Validation{
         {headerParameter,
         []validation.Constraint{	{"headerParameter", validation.Null, true ,
         []validation.Constraint{	{"headerParameter", validation.Empty, true, nil },
         }}}}}); err != nil {
...
func (client ExplicitClient) PostRequiredArrayParameter(bodyParameter []string) (result Error, err error) {
    if err := validation.Validate([]validation.Validation{
         {bodyParameter,
         []validation.Constraint{	{"bodyParameter", validation.Null, true ,
         []validation.Constraint{	{"bodyParameter", validation.Empty, true, nil },
         }}}}}); err != nil {
...
func (client ExplicitClient) PostRequiredStringHeader(headerParameter string) (result Error, err error) {
    if err := validation.Validate([]validation.Validation{
         {headerParameter,
         []validation.Constraint{	{"headerParameter", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "optionalgroup.ExplicitClient", "PostRequiredStringHeader", nil , "Validation error ")
    }
...
func (client ExplicitClient) PostRequiredStringParameter(bodyParameter string) (result Error, err error) {
    if err := validation.Validate([]validation.Validation{
         {bodyParameter,
         []validation.Constraint{	{"bodyParameter", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "optionalgroup.ExplicitClient", "PostRequiredStringParameter", nil , "Validation error ")
    }
