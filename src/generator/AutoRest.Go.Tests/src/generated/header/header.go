...
func (client HeaderClient) ParamBool(scenario string, value bool) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamBool", nil , "Validation error ")
    }
...
func (client HeaderClient) ParamByte(scenario string, value []byte) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}},
         {value,
         []validation.Constraint{	{"value", validation.Null, true ,
         []validation.Constraint{	{"value", validation.Empty, true, nil },
         }}}}}); err != nil {
...
func (client HeaderClient) ParamDate(scenario string, value date.Date) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamDate", nil , "Validation error ")
    }
...
func (client HeaderClient) ParamDatetime(scenario string, value date.Time) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamDatetime", nil , "Validation error ")
    }
...
func (client HeaderClient) ParamDatetimeRfc1123(scenario string, value *date.TimeRFC1123) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamDatetimeRfc1123", nil , "Validation error ")
    }
...
func (client HeaderClient) ParamDouble(scenario string, value float64) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamDouble", nil , "Validation error ")
    }
...
func (client HeaderClient) ParamDuration(scenario string, value string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamDuration", nil , "Validation error ")
    }
...
func (client HeaderClient) ParamEnum(scenario string, value GreyscaleColors) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamEnum", nil , "Validation error ")
    }
...
func (client HeaderClient) ParamExistingKey(userAgent string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {userAgent,
         []validation.Constraint{	{"userAgent", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamExistingKey", nil , "Validation error ")
    }
...
func (client HeaderClient) ParamFloat(scenario string, value float64) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamFloat", nil , "Validation error ")
    }
...
func (client HeaderClient) ParamInteger(scenario string, value int32) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamInteger", nil , "Validation error ")
    }
...
func (client HeaderClient) ParamLong(scenario string, value int64) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamLong", nil , "Validation error ")
    }
...
func (client HeaderClient) ParamProtectedKey(contentType string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {contentType,
         []validation.Constraint{	{"contentType", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamProtectedKey", nil , "Validation error ")
    }
...
func (client HeaderClient) ParamString(scenario string, value string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ParamString", nil , "Validation error ")
    }
...
func (client HeaderClient) ResponseBool(scenario string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ResponseBool", nil , "Validation error ")
    }
...
func (client HeaderClient) ResponseByte(scenario string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ResponseByte", nil , "Validation error ")
    }
...
func (client HeaderClient) ResponseDate(scenario string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ResponseDate", nil , "Validation error ")
    }
...
func (client HeaderClient) ResponseDatetime(scenario string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ResponseDatetime", nil , "Validation error ")
    }
...
func (client HeaderClient) ResponseDatetimeRfc1123(scenario string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ResponseDatetimeRfc1123", nil , "Validation error ")
    }
...
func (client HeaderClient) ResponseDouble(scenario string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ResponseDouble", nil , "Validation error ")
    }
...
func (client HeaderClient) ResponseDuration(scenario string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ResponseDuration", nil , "Validation error ")
    }
...
func (client HeaderClient) ResponseEnum(scenario string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ResponseEnum", nil , "Validation error ")
    }
...
func (client HeaderClient) ResponseFloat(scenario string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ResponseFloat", nil , "Validation error ")
    }
...
func (client HeaderClient) ResponseInteger(scenario string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ResponseInteger", nil , "Validation error ")
    }
...
func (client HeaderClient) ResponseLong(scenario string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ResponseLong", nil , "Validation error ")
    }
...
func (client HeaderClient) ResponseString(scenario string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {scenario,
         []validation.Constraint{	{"scenario", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "headergroup.HeaderClient", "ResponseString", nil , "Validation error ")
    }
