...
func (client ManagementClient) GetWithConstantInPath(constantParam string) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         {constantParam,
         []validation.Constraint{	{"constantParam", validation.Empty, true, nil }}}}); err != nil {
             return result, autorest.NewErrorWithError(err, "validationgroup.ManagementClient", "GetWithConstantInPath", nil , "Validation error ")
    }
...
func (client ManagementClient) PostWithConstantInBody(constantParam string, body *Product) (result Product, err error) {
    if err := validation.Validate([]validation.Validation{
         {constantParam,
         []validation.Constraint{	{"constantParam", validation.Empty, true, nil }}},
         {body,
...
func (client ManagementClient) ValidationOfBody(resourceGroupName string, id int32, body *Product) (result Product, err error) {
    if err := validation.Validate([]validation.Validation{
         ...
         []validation.Constraint{	{"client.SubscriptionID", validation.Empty, true, nil }}},
         {resourceGroupName,
         []validation.Constraint{	{"resourceGroupName", validation.Empty, true, nil },
         	{"resourceGroupName", validation.MaxLength, 10, nil },
